                ...
                <div class="x_panel" >
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                      ...
                      <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Buscar falta</a>
                      </li>
                      <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Registrar falta</a>
                      </li>
                          ...
                          <form id="formulariofalta" data-parsley-validate class="form-horizontal form-label-left" action="controladores/insertarfalta.php" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="txtfalta" name="txtfalta" required="required" class="form-control col-md-7 col-xs-12" onkeypress="SoloLetras()" onKeyUp="this.value = this.value.toUpperCase();">
                              </div>
                            </div>
