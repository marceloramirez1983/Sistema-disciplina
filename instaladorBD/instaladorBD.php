...
//-------------------------------TABLE FALTA----------------------------------
	...
	if(mysqli_query($con,$TB_FALTA)){
		...
		VALUES ('','ATRASARSE A FORMACION','1'),
					 ...
					 ('','PERMANECER SIN AUTORIZACION EN LAS INMEDIACIONES O DENTRO DEL PABELLON DE ALUMNAS Y ALUMNOS','2'),
					 ...
					 ('','NO INCORPORARSE A LA ESCUELA INMEDIATAMENTE DESPUES DE SER DADO DE ALTA DEL HOSPITAL O COSSMIL','3'),
					 ...
					 ('','NO OBSERVAR MEDIDAS DE SEGURIDAD AL MANEJAR EXPLOSIVOS ARMAMENTO MUNICION SIEMPRE QUE NO SEA UN DELITO','3'),
					 ...
					 ('','NO PRESENTARSE A LA AUTORIDAD MILITAR EN LAS VACACIONES O CUANDO LA ALUMNA O ALUMNO SALE DE LA GUARNICION','4'),
					 ...
					 ('','REALIZAR CHISTES PIROPOS CONVERSACIONES DE CONTENIDO SEXUAL QUE DAÑEN Y AFECTEN LA DIGNIDAD DE UNA PERSONA EFECTUADO POR UN SUPERIOR O ALUMNO DEL MISMO','5'),
					 ('','EL SUPERIOR O DEL MISMO CURSO APROVECHANDO SU GRADO POSICION CARGO O FUNCION REALICE MIRADAS MUECAS GESTOS LASCIVOS QUE AFECTEN LA DIGNIDAD DE UNA PERSONA','5'),
