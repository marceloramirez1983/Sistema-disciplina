...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>EDITAR GRADOS REGISTRADOS</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="height:600px;">
                  <div class="x_title">
                    ...
                    <form id="demoform2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="controladores/ActualizarGrado.php">
                      <?php
                      $query=mysqli_query($con,"SELECT * FROM grado WHERE id_grado = $idEditar");
                      while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)):?>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Id Grado
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtid_grado" name="txtid_grado" readonly required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['id_grado'] ?>">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Abreviacion Grado<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtabreviacion_grado" name="txtabreviacion_grado" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['grado'] ?>" onkeypress="SoloLetras()">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtnombre_grado" name="txtnombre_grado" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['descripcion'] ?>" onkeypress="SoloLetras()">
                        </div>
                      </div>
                      <?php Endwhile; ?>
    ...
    function valida_envia(){
      ...
      valor1 = document.getElementById("txtnombre_grado").value;
      if( valor1 == null || valor1.length == 0 || /^\s+$/.test(valor1) ) {
      alert ("Ingrese el nombre grado")
      return false;
      }

      valor = document.getElementById("txtabreviacion_grado").value;
      if( valor == null || valor.length == 0 || /^\s+$/.test(valor) ) {
      alert ("Ingrese una abreviacion para el grado")
      return false;
      }
      demoform2.submit();
    }
