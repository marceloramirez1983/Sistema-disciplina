                  ...
                  <div class="x_title">
                    ...
                    <form id="demoform2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="controladores/Actualizarfalta.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtnombre_falta" name="txtnombre_falta" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['nombre'] ?>" onKeyUp="this.value = this.value.toUpperCase();">
                        </div>
                      </div>
