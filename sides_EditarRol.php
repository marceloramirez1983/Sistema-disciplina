...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>EDITAR ROLES REGISTRADOS</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="height:600px;">
                  <div class="x_title">
                    ...
                    <form id="demoform2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="controladores/ActualizarRol.php">
                      <?php
                      $query=mysqli_query($con,"SELECT * FROM rol WHERE id_rol = $idEditar");
                      while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)):?>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Id Rol
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtid_rol" name="txtid_rol" readonly required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['id_rol'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtnombre_rol" name="txtnombre_rol" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['rol'] ?>" onkeypress="SoloLetras()">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtdescripcion_rol" name="txtdescripcion_rol" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['descripcion'] ?>" onkeypress="SoloLetras()">
                        </div>
                      </div>
                      <?php Endwhile; ?>
    ...
    function valida_envia(){
      ...
      alert ("Ingrese el nombre rol")
      return false;
      }

      valor = document.getElementById("txtdescripcion_rol").value;
      if( valor == null || valor.length == 0 || /^\s+$/.test(valor) ) {
      alert ("Ingrese una descripcion del rol")
      return false;
      }
      demoform2.submit();
    }
